...
if __name__ == '__main__':
    ...
    # download model
    if args.model in ['resnet18_v1', 'resnet50_v1', 'resnet101_v1', 'squeezenet1.0', 'mobilenet1.0', 'mobilenetv2_1.0', 'inceptionv3']:
    ...
    elif args.model in ['mobilenet1.0', 'mobilenetv2_1.0']:
        rgb_mean = '123.68,116.779,103.939'
        rgb_std = '58.393, 57.12, 57.375'
